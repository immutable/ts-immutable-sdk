...
describe('getStarkSigner', () => {
  ...
  it('should get StarkSigner', async () => {
    const expectStarkAddress = '0x0245ce06e96c7257407ef6e9e59c2b1b30d0def22e7c470a136fbdee16f65798';
  ...
  describe('signMessage', () => {
    it('should get signed message', async () => {
      ...
      const expectedSignature = '0x03a6d3fcf588f9db669988de05c3e53dd2a6270a646b038adc6909671174ab9c0224a8ca991abbfd6c9790d89c33831a0ce6fdb04e5bc3fef9bb8d50024d70d2';
