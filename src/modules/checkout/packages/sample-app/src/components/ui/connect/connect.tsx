...
import { TestWidget } from "@imtbl/checkout-ui";
...
//       <Heading size="small" className="sample-heading">Checkout Connect (Injected Widget)</Heading>
//       <div className="divider"></div>
//       <span id="imtbl-checkout-connect"></span>
//       <Heading size="small" className="sample-heading">Checkout Connect (React Component)</Heading>
