import {ProviderPreference, IMTBLWidgetEvents, ConnectEvent, ConnectionSuccess, ConnectionFailed, ConnectEventType } from '@imtbl/checkout-ui-types'
import {addToLocalStorage} from '@imtbl/checkout-ui-lib'

export function sendConnectSuccessEvent(providerPreference: ProviderPreference){
