...
import { UnsignedTransferRequest, TransfersApi, NftTransferDetails } from "@imtbl/core-sdk";
    ...
    test('should make the correct api requests with the correct params, and return the correct receipt', async () => {
      ...
      expect(createTransferMock).toHaveBeenCalledWith({
        createTransferRequestV2: {
          requests: [
            {
              sender_vault_id: getSignableTransferResponse.signable_responses[0].sender_vault_id,
              receiver_stark_key: getSignableTransferResponse.signable_responses[0].receiver_stark_key,
              receiver_vault_id: getSignableTransferResponse.signable_responses[0].receiver_vault_id,
              asset_id: getSignableTransferResponse.signable_responses[0].asset_id,
              ...
              expiration_timestamp: getSignableTransferResponse.signable_responses[0].expiration_timestamp,
              stark_signature: "payload-hashSTXd90915fa5bce418a23184c9asdfasfasdf5c8e900e3035cf34e2dd36",
            }
          ],
          sender_stark_key: getSignableTransferResponse.sender_stark_key,
