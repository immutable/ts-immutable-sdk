    ...
    test('should make the correct api requests with the correct params, and return the correct receipt', async () => {
      ...
      expect(createExchangeTransferMock).toHaveBeenCalledWith({
        createTransferRequest: {
          sender_stark_key: getSignableExchangeTransferResponse.sender_stark_key,
          sender_vault_id: getSignableExchangeTransferResponse.sender_vault_id,
          receiver_stark_key: getSignableExchangeTransferResponse.receiver_stark_key,
          receiver_vault_id: getSignableExchangeTransferResponse.receiver_vault_id,
          ...
          expiration_timestamp: getSignableExchangeTransferResponse.expiration_timestamp,
