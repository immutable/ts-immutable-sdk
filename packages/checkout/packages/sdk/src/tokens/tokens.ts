import { ChainId, GetTokenAllowListResult, TokenInfo } from "../types"
...
export const ethTokensList: TokenInfo[] = [
  {
    name: 'Ethereum',
    symbol: 'ETH',
    decimals: 18,
...
const goerliTokensList: TokenInfo[] = [
  {
    name: 'Ethereum',
    symbol: 'ETH',
    decimals: 18,
...
const polygonTokensList: TokenInfo[] = [
];

export const getTokenAllowList = (chainId: ChainId): GetTokenAllowListResult => {
  let tokenList: TokenInfo[] = [];
  switch(chainId) {
    case ChainId.ETHEREUM: {
      tokenList = ethTokensList;
      break;
    }
    case ChainId.GOERLI: {
      tokenList = goerliTokensList;
      break;
    }
