...
export interface ServiceUnavailableSanctionsErrorViewProps {
  onCloseClick: () => void;
  onBackButtonClick?: () => void;
}

export function ServiceUnavailableSanctionsErrorView({
  onCloseClick,
  onBackButtonClick,
}: ServiceUnavailableSanctionsErrorViewProps) {
  ...
  return (
    <SimpleLayout
      ...
      floatHeader
      testId="service-unavailable-sanctions-error-view"
    >
      <Box
        sx={{
          textAlign: 'center',
