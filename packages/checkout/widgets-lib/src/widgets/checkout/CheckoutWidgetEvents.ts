...
export type CheckoutEventDetail = {
  ...
  data: WidgetEventData[WidgetType.UNIFIED_COMMERCE][keyof WidgetEventData[WidgetType.UNIFIED_COMMERCE]];
};
...
export const sendCheckoutEvent = (
  ...
  WidgetEvent<WidgetType.UNIFIED_COMMERCE, CheckoutEventType>
