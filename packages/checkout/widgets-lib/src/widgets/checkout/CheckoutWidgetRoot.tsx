...
export class CheckoutWidgetRoot extends Base<WidgetType.UNIFIED_COMMERCE> {
  protected eventTopic: IMTBLWidgetEvents = IMTBLWidgetEvents.IMTBL_CHECKOUT_WIDGET_EVENT;

  protected getValidatedProperties({
    config,
  }: WidgetProperties<WidgetType.UNIFIED_COMMERCE>): WidgetProperties<WidgetType.UNIFIED_COMMERCE> {
