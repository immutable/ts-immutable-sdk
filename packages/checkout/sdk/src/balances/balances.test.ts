    ...
    it('should throw an error if the contract address is invalid', async () => {
      ...
      await expect(
        ...
        new CheckoutError(
          ...
          '[GET_ERC20_BALANCE_ERROR] Cause:Cause:invalid contract address or ENS name (argument="addressOrName", value=undefined, code=INVALID_ARGUMENT, version=contracts/5.7.0)',
          CheckoutErrorType.GET_ERC20_BALANCE_ERROR,
        ),
      );
    });
