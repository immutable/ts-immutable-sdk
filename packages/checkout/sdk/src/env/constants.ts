...
export const TESTNET_ZKEVM_NATIVE_TOKEN = {
  name: 'tIMX',
  symbol: 'tIMX',
  decimals: DEFAULT_TOKEN_DECIMALS,
  address: NATIVE,
...
>([
  ...
  [
    ChainId.IMTBL_ZKEVM_TESTNET,
    {
      ...
      nativeCurrency: TESTNET_ZKEVM_NATIVE_TOKEN,
...
export const WALLET_CONNECT_PRODUCTION = {
  ...
  optionalMethods: ['eth_chainId', 'eth_accounts', 'wallet_addEthereumChain', 'wallet_switchEthereumChain'],
  rpcMap: {
