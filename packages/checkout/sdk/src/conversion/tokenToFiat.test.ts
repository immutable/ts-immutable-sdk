...
// jest.mock('./helpers', () => {
//   const mockedModule = {
//     fetchConversionRates: jest.fn(),
//     fetchTokenIds: jest.fn(),
//     fetchQuotesFromCoinGecko: jest.fn(),
//   };
...
//       (helpers.fetchConversionRates as unknown as jest.Mock).mockResolvedValue({
//         ETH: {
//           quote: 1000.0,
//           quotedAt: 12345,
//         },
