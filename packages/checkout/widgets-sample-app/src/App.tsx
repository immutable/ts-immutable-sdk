  ...
  return (
    <div>
      <main className="checkout-sdk-app">
        ...
        <br />
        <div>
          <a href={'/sale?amount=0.01&fromContractAddress=0x21B51Ec6fB7654B7e59e832F9e9687f29dF94Fb8&environmentId=4dfc4bec-1867-49aa-ad35-d8a13b206c94&env=sandbox'}>Sale Widget</a>
        </div>
        <br />
        <div>
