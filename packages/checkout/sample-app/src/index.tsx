...
import SdkLayout from "./sdk/SdkLayout";
import SdkHome from "./sdk/SdkHome";
import SdkConnect from "./sdk/pages/ConnectWidget";
import SdkSmartCheckout from "./sdk/pages/SmartCheckout";
import { PassportLoginCallback as SdkPassportLoginCallback } from "./sdk/components/PassportLoginCallback";
...
const router = createBrowserRouter([
  ...
  },
  {
    ...
    element: <SdkLayout />,
    children: [
      { index: true, element: <SdkHome /> },
      { path: "connect", element: <SdkConnect /> },
      { path: "smart-checkout", element: <SdkSmartCheckout /> },
      { path: "login/callback", element: <SdkPassportLoginCallback /> },
    ],
  },
  {
    path: "/connect",
