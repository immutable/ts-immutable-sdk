...
export const ViewThree = () => {
  const [currentContent, setCurrentContent] = useState(ViewThreeContents.CONTENT_ONE);
  ...
  */
  ...
  return (
    <SimpleLayout 
      header={
        <HeaderNavigation
          showClose
          showBack
          onBackButtonClick={currentContent === ViewThreeContents.CONTENT_TWO ? () => switchContent(currentContent) : undefined}
        />
      }
      footer={
    ...
    >
      {currentContent === ViewThreeContents.CONTENT_ONE && <ViewThreeContentOne/>}
      {currentContent === ViewThreeContents.CONTENT_TWO && <ViewThreeContentTwo/>}
    </SimpleLayout>
  )
}
