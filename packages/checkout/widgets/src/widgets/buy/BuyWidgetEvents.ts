...
export const sendBuySuccessEvent = () => {
  const successEvent = new CustomEvent<BuyEvent<BuySuccess>>(IMTBLWidgetEvents.IMTBL_BUY_WIDGET_EVENT , {
    detail: {
...
export const sendBuyFailedEvent = (reason: string) => {
  const failedEvent = new CustomEvent<BuyEvent<BuyFailed>>(IMTBLWidgetEvents.IMTBL_BUY_WIDGET_EVENT, {
    detail: {
...
export const sendBuyWidgetCloseEvent = () => {
  const closeEvent = new CustomEvent<BuyEvent<BuyClose>>(IMTBLWidgetEvents.IMTBL_BUY_WIDGET_EVENT, {
    detail: {
...
export const sendBuyWidgetNotConnectedEvent = (providerPreference: string) => {
  const notConnectedEvent = new CustomEvent<BuyEvent<BuyNotConnected>>(IMTBLWidgetEvents.IMTBL_BUY_WIDGET_EVENT, {
    detail: {
