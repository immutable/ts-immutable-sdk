...
// svg used straight from EthereumPlanet.svg
// need to find another way to import and use svgs as not using CRA anymore
    ...
    <Box sx={{ ...heroBackGroundStyles, background: 'base.color.translucent.emphasis.100' }}>
      <Box sx={heroImageStyles}>
        <svg width="430" height="305" viewBox="0 0 430 305" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M285.46 210.21C301.83 185.997 303.176 150.358 288.657 126.436C264.343 181.76 222.7 210.182 162.039 214.668C196.043 256.29 260.627 246.94 285.46 210.21Z" fill="#07064F" fillOpacity="0.15" />
          ...
          <path d="M174.625 103.001C192.219 89.417 213.762 83.7236 234.049 87.152C263.033 92.0497 256.216 108.13 209 125.891C167.74 141.407 142.908 139.054 160.659 116.817C164.674 111.79 169.3 107.11 174.625 103.001Z" fill="white" fillOpacity="0.3" />
          ...
          <path d="M86.4526 104.341L85.9012 102.24L83.8006 102.793L84.3519 104.895L86.4526 104.341Z" fill="white" />
          ...
          <path d="M98.4247 201.101L97.8734 199L95.7728 199.554L96.3241 201.655L98.4247 201.101Z" fill="white" />
          <path d="M354.828 140.101L354.277 138L352.176 138.554L352.728 140.655L354.828 140.101Z" fill="white" />
          <path d="M69.1251 245.906L69.743 244.619L68.4575 243.999L67.8396 245.286L69.1251 245.906Z" fill="white" />
          <path d="M92.782 87.5861L94.3684 89.0703L95.8489 87.4805L94.2626 85.9963L92.782 87.5861Z" fill="white" />
          <path d="M55.8704 152.162L56.0323 153.581L57.4504 153.418L57.2884 152L55.8704 152.162Z" fill="white" />
          <defs>
            <linearGradient id="paint0_linear_7858_3468" x1="167.075" y1="106.02" x2="286.338" y2="228.311" gradientUnits="userSpaceOnUse">
              <stop offset="0.0729167" stopColor="#B5C0F2" />
              <stop offset="0.96875" stopColor="#B9C6FE" stopOpacity="0.43" />
            </linearGradient>
            <linearGradient id="paint1_linear_7858_3468" x1="280.221" y1="105.891" x2="301.258" y2="132.847" gradientUnits="userSpaceOnUse">
              <stop stopColor="white" />
              <stop offset="1" stopColor="#A2B0EF" />
            </linearGradient>
            <linearGradient id="paint2_linear_7858_3468" x1="147.465" y1="244.014" x2="128.872" y2="217.089" gradientUnits="userSpaceOnUse">
              <stop stopColor="#5C6184" stopOpacity="0" />
