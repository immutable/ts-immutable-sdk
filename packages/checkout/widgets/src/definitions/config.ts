...
/**
 * Represents the version of the Checkout Widgets to use defaults to (0.1.0)
 * @property {number} major - The major version of the widgets, must specify a major version even if it is 0, otherwise version defaults to (0.1.0)
 ...
 * @property {string} build - The build version of the widgets, this should not be used in production and will only be used for rare cases when a specific testing is required
 *
 * @example
 * { major: 0 } - use default version 0.1.0
 *
