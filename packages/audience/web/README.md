...
sdk.track(AudienceEvent.GameLaunch, { platform: 'webgl', version: '1.2.0' });
sdk.track(AudienceEvent.Progression, { status: 'complete', level: 5, score: 12000 });
sdk.track(AudienceEvent.Resource, { flow: 'sink', currency: 'gold', amount: 100, itemType: 'weapon' });
```
