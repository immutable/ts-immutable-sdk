...
describe('generateSnippet', () => {
  ...
  it('includes consent level when provided', () => {
    const html = generateSnippet({ key: 'pk_imapik-test-123', consent: 'anonymous' });
