...
describe('StarkSigner', () => {
  it('should return correct address', async () => {
    const mockPrivateKey = '019b5de47e5fc8f2e8c3415b42a126aadb462637f2feca1df3733fe3f37cf50f';
  ...
  it('should sign message and produce expected signature', async () => {
    const privateKey = '7CEFD165C3A374AC3E05170D699BF6549E371522883B447B284A3C16FC04CCC';
