...
export const TransactionApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        signMessageV1WalletPersonalSignPost: async (personalSignRequest: PersonalSignRequest, xMagicAPIKey?: string, xMagicSecretKey?: string, xOIDCProviderID?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'personalSignRequest' is not null or undefined
            assertParamExists('signMessageV1WalletPersonalSignPost', 'personalSignRequest', personalSignRequest)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(personalSignRequest, localVarRequestOptions, configuration)
...
export const TransactionApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async signMessageV1WalletPersonalSignPost(personalSignRequest: PersonalSignRequest, xMagicAPIKey?: string, xMagicSecretKey?: string, xOIDCProviderID?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PersonalSignResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.signMessageV1WalletPersonalSignPost(personalSignRequest, xMagicAPIKey, xMagicSecretKey, xOIDCProviderID, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const TransactionApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        signMessageV1WalletPersonalSignPost(requestParameters: TransactionApiSignMessageV1WalletPersonalSignPostRequest, options?: AxiosRequestConfig): AxiosPromise<PersonalSignResponse> {
            return localVarFp.signMessageV1WalletPersonalSignPost(requestParameters.personalSignRequest, requestParameters.xMagicAPIKey, requestParameters.xMagicSecretKey, requestParameters.xOIDCProviderID, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class TransactionApi extends BaseAPI {
     ...
     */
    public signDataV1WalletSignPost(requestParameters: TransactionApiSignDataV1WalletSignPostRequest, options?: AxiosRequestConfig) {
        return TransactionApiFp(this.configuration).signDataV1WalletSignPost(requestParameters.signDataRequest, requestParameters.xMagicAPIKey, requestParameters.xMagicSecretKey, requestParameters.xOIDCProviderID, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TransactionApi
     */
    public signMessageV1WalletPersonalSignPost(requestParameters: TransactionApiSignMessageV1WalletPersonalSignPostRequest, options?: AxiosRequestConfig) {
        return TransactionApiFp(this.configuration).signMessageV1WalletPersonalSignPost(requestParameters.personalSignRequest, requestParameters.xMagicAPIKey, requestParameters.xMagicSecretKey, requestParameters.xOIDCProviderID, options).then((request) => request(this.axios, this.basePath));
    }
}
