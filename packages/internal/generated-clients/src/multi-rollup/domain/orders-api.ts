...
export const OrdersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {ListBidsSellItemTypeEnum} [sellItemType] Sell item type to filter by
         ...
         * @throws {RequiredError}
         */
        listBids: async (chainName: string, status?: OrderStatusName, buyItemContractAddress?: string, sellItemType?: ListBidsSellItemTypeEnum, sellItemContractAddress?: string, accountAddress?: string, buyItemMetadataId?: string, buyItemTokenId?: string, fromUpdatedAt?: string, pageSize?: number, sortBy?: ListBidsSortByEnum, sortDirection?: ListBidsSortDirectionEnum, pageCursor?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'chainName' is not null or undefined
            ...
            if (sellItemType !== undefined) {
                localVarQueryParameter['sell_item_type'] = sellItemType;
            }
...
export const OrdersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async listBids(chainName: string, status?: OrderStatusName, buyItemContractAddress?: string, sellItemType?: ListBidsSellItemTypeEnum, sellItemContractAddress?: string, accountAddress?: string, buyItemMetadataId?: string, buyItemTokenId?: string, fromUpdatedAt?: string, pageSize?: number, sortBy?: ListBidsSortByEnum, sortDirection?: ListBidsSortDirectionEnum, pageCursor?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListBidsResult>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listBids(chainName, status, buyItemContractAddress, sellItemType, sellItemContractAddress, accountAddress, buyItemMetadataId, buyItemTokenId, fromUpdatedAt, pageSize, sortBy, sortDirection, pageCursor, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * List all listings
...
export interface OrdersApiListBidsRequest {
    ...
    /**
     * Sell item type to filter by
     * @type {'NATIVE' | 'ERC20'}
     * @memberof OrdersApiListBids
     */
    readonly sellItemType?: ListBidsSellItemTypeEnum
 ...
 * @export
 */
export const ListBidsSellItemTypeEnum = {
    Native: 'NATIVE',
    Erc20: 'ERC20'
} as const;
export type ListBidsSellItemTypeEnum = typeof ListBidsSellItemTypeEnum[keyof typeof ListBidsSellItemTypeEnum];
/**
 * @export
 */
