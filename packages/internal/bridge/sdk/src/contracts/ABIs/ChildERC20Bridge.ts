export const CHILD_ERC20_BRIDGE = [
  ...
  {
    inputs: [],
    name: 'EmptyTokenContract',
    type: 'error',
  },
  {
    inputs: [],
    name: 'IncorrectBridgeAddress',
    type: 'error',
  },
  {
    inputs: [],
  ...
  },
  {
    ...
    name: 'ChildChainNativeIMXWithdraw',
    type: 'event',
  },
  {
    anonymous: false,
    ...
    name: 'ChildChainWrappedIMXWithdraw',
    type: 'event',
  },
  {
    anonymous: false,
    ...
    inputs: [
      {
        ...
        internalType: 'struct IChildERC20Bridge.InitializationRoles',
        name: 'newRoles',
        type: 'tuple',
      },
      {
        internalType: 'address',
        name: 'newBridgeAdaptor',
        type: 'address',
      },
      {
        internalType: 'string',
