export const CHILD_AXELAR_ADAPTER = [
  {
    inputs: [
      {
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: 'contract IChildERC20Bridge',
        name: '',
        type: 'address',
      },
    ],
    ...
    inputs: [
      {
        ...
        internalType: 'struct IChildAxelarBridgeAdaptor.InitializationRoles',
        name: '_adaptorRoles',
        type: 'tuple',
      },
      {
