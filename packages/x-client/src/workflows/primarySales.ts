...
export async function CreatePrimarySaleWorkflow({
  ...
  const signablePrimarySaleResponse = await primarySalesApi.signableCreatePrimarySale(request);
...
export async function AcceptPrimarySalesWorkflow({
  ...
  const signableAcceptPrimarySaleResult = await primarySalesApi.signableAcceptPrimarySale({
    id: primarySaleId,
  });
...
export async function RejectPrimarySalesWorkflow({
  ...
  const signableRejectPrimarySaleResult = await primarySalesApi.signableRejectPrimarySale({
    id: primarySaleId,
  });
