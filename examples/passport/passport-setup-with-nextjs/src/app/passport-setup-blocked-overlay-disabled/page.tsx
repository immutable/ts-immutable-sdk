...
import { passportInstanceWithBlockedOverlayDisabled as specificInstance } from '../utils/setupDefault';
import { UserProfile } from '@imtbl/sdk/passport';

export default function PassportSetupBlockedOverlayDisabledPage() {
  ...
  return (
    <>
      <Heading size="medium" className="mb-1">Passport Setup: Blocked Popup Overlay Disabled</Heading>
      <p className="mb-1">Testing Passport behavior using the <strong>Blocked Popup Overlay Disabled</strong> configuration.</p>
      {!isClientReady && error && (
