...
import { passportInstanceWithAllScopes as specificInstance } from '../utils/setupDefault';
import { UserProfile } from '@imtbl/sdk/passport';

export default function PassportSetupAllScopesPage() {
  ...
  return (
    <>
      <Heading size="medium" className="mb-1">Passport Setup: All Scopes (email, transact, etc)</Heading>
      <p className="mb-1">Testing Passport behavior using the <strong>All Scopes (email, transact, etc)</strong> configuration.</p>
      {!isClientReady && error && (
