import { ImmutableX, generateLegacyStarkPrivateKey, createStarkSigner, TransfersApi, OrdersApi, UsersApi, Contracts, WithdrawalsApi, EncodingApi, MintsApi, TradesApi, DepositsApi, TokensApi, ExchangesApi, Config } from '@imtbl/core-sdk';
...
class MetaMaskIMXProvider extends GenericIMXProvider {
    ...
    static async connect(config) {
        ...
        const imxSigner = await connect(metaMaskProvider, starkExConfig.env);
        return new MetaMaskIMXProvider(config, metaMaskProvider.getSigner(), imxSigner);
    }
}

export { Auth, Checkout, Configuration, Environment, GenericIMXProvider, MetaMaskIMXProvider, PRODUCTION, Passport, PassportError, SANDBOX, StarkExAPIFactory };
