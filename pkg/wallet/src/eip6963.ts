 ...
 * Allows dApps to discover Passport wallet automatically
 */
...
/**
 * Generate a UUID v4 (simple implementation without external dependency)
 */
...
/**
 * Passport provider info for EIP-6963
 */
export const passportProviderInfo: EIP6963ProviderInfo = {
...
/**
 * Announces the provider via EIP-6963
 */
