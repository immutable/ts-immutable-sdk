...
## Releasing
Immutable team will take responsibilities to release successful PRs contributed, including versioning decisions.

### PR titles
Publishing a SDK to NPM will create a new GitHub release with auto-generated release notes to communicate changes between releases. These auto-generated notes are a list of PR titles that have been merged since the last release.
